function Privacy() {
  return (
    <>
      <div>
        <p>
          &lt;카페콘닷컴 &gt;(&apos;cafecon.co.kr&apos;이하
          &apos;카페콘&apos;)&nbsp; 은(는) 「개인정보 보호법」 제30조에 따라
        ...
        <p>
          ① &lt;카페콘닷컴 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성
        ...
        <p>1. 파기절차</p>
        <p>
          &lt;카페콘닷컴&gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt;
          카페콘닷컴&gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를
          파기합니다.
        </p>
        <p>2. 파기방법</p>
        <p>
        ...
        <p>
          ...
          있으며 카페콘닷컴 은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p>
        ...
        <p>
          ⑥ 카페콘닷컴은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <p>
          <strong>
            &lt;카페콘닷컴 &gt;&nbsp;은(는) 개인정보의 안전성 확보를 위해 다음과
            같은 조치를 취하고 있습니다.
          </strong>
        </p>
        <p>1. 정기적인 자체 감사 실시</p>
        ...
        <p>
          &lt;카페콘닷컴&gt; 은(는) 다음과 같은 목적으로 가명정보를 처리하고
          있습니다.
        </p>
        <p>▶ 가명정보의 처리 목적</p>
        <p>- 직접작성 가능합니다.</p>
        ...
        <p>
          <strong>
            &lt;카페콘닷컴 &gt;은(는) 정보주체의 개인정보 열람청구가 신속하게
            처리되도록 노력하겠습니다.
          </strong>
        </p>
        <p>
